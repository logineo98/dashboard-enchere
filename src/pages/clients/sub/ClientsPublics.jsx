...
const ClientsPublics = () => {
    ...
    const column = [
        ...
        { name: "Nb. articles", selector: (row) => encheres?.filter(enchere => (enchere?.sellerID === row?._id && enchere?.enchere_type === "public"))?.length, sortable: true, },
